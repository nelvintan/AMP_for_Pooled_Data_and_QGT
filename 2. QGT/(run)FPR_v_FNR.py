...
def run_GAMP_v_SE_multi_threshold(p, n, threshold_list, alpha, nu, num_iter, num_runs, num_MC_samples):
  ...
  for threshold_index in range(num_thresholds):
    ...
    for run_num in range(num_runs):
      ...
      beta_hat_storage, mu_k_b_storage = run_GAMP_threshold(n, p, X_tilde, y_tilde, nu, beta, beta_bar_mean, beta_bar_var, beta_hat_0, threshold, num_iter)                                                         
...
output_list1 = run_GAMP_v_SE_multi_threshold(p, n, threshold_list, alpha, nu, num_iter, num_runs, num_MC_samples)

delta = 0.3
p = 500
n = int(delta*p)

output_list2 = run_GAMP_v_SE_multi_threshold(p, n, threshold_list, alpha, nu, num_iter, num_runs, num_MC_samples)

delta = 0.1
p = 500
n = int(delta*p)

output_list3 = run_GAMP_v_SE_multi_threshold(p, n, threshold_list, alpha, nu, num_iter, num_runs, num_MC_samples)
