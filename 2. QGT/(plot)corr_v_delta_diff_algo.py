...
def plot_GAMP_v_SE(p, n_list, input_name, output_name):

  output_list = load(input_name)

  mean_final_corr_list_AMP = output_list[0]
  mean_final_corr_list_LP = output_list[1]
  SD_final_corr_list_AMP = output_list[2]
  SD_final_corr_list_LP = output_list[3]
  ...
  plt.errorbar(delta_list, mean_final_corr_list_LP, yerr=SD_final_corr_list_LP, color='red', ecolor='red', elinewidth=3, capsize=10, label=r"LP")
...
plot_GAMP_v_SE(p, n_list, input_name1, output_name1)
plot_GAMP_v_SE(p, n_list, input_name2, output_name2)