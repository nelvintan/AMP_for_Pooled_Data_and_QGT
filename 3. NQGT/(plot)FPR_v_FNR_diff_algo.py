...
def plot_FPR_v_FNR(input_name, output_name):
  ...
  mean_final_FPR_list_BPD = output_list[4]
  mean_final_FNR_list_BPD = output_list[5]

  plt.plot(mean_final_FNR_list, mean_final_FPR_list, linestyle='solid', marker='.', mfc='none', color='blue', markersize=10, label=r"AMP")
  plt.plot(mean_final_FNR_list_BPD, mean_final_FPR_list_BPD, linestyle='solid', marker='x', mfc='none', color='red', markersize=10, label=r"BPDN")
...
plot_FPR_v_FNR(input_name1, output_name1)
plot_FPR_v_FNR(input_name2, output_name2)
