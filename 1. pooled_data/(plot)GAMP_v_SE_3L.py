...
def plot_GAMP_v_SE_multi_delta(p, n_list):
  ...
  output_list = load('GAMP_v_SE_3L.npy')
  ...
  plt.errorbar(delta_list, mean_final_corr_list1, yerr=SD_final_corr_list1, color='blue', ecolor='blue', elinewidth=3, capsize=10, label=r"AMP, [1/3, 1/3, 1/3]")
  plt.plot(delta_list, mean_final_corr_list_SE1, linestyle='None', marker='o', mfc='none', color='blue', markersize=10, label=r"SE, [1/3, 1/3, 1/3]")
  plt.errorbar(delta_list, mean_final_corr_list2, yerr=SD_final_corr_list2, color='red', ecolor='red', elinewidth=3, capsize=10, label=r"AMP, [0.1, 0.3, 0.6]")
  plt.plot(delta_list, mean_final_corr_list_SE2, linestyle='None', marker='o', mfc='none', color='red', markersize=10, label=r"SE, [0.1, 0.3, 0.6]")
  ...
  plt.savefig('noiseless_3L.pdf', bbox_inches='tight')
  plt.show()
